...
const Testimonials = () => {
  ...
  return (
    <section id='testimonials' className="w-full mt-24 p-4">
      <div className="container mx-auto flex flex-col justify-start items-center gap-8">
        ...
        <div className="flex flex-col justify-start items-center gap-4 lg:flex-row lg:justify-between">
...
const ReviewCard = ({image, comment, name, title, stars}: {image: any, comment: string, name: string, title: string, stars: number}) => {
  ...
  return (
    <div className="h-[440px] flex flex-col justify-end items-center gap-4 p-4 bg-primary-900 rounded-2xl shadow-[0px_0px_4px_0px_rgba(0,0,0,0.35)] outline-1 outline-[#ACAEF7]/20 relative overflow-hidden">
      ...
      <p className='text-neutral-300 text-xl leading-[30px] text-center'>{`"${comment}"`}</p>
